...
$context = requireModuleAccess('desarrollo-usuarios');
$user = $context['user'];
$module = $context['module'];
$menu = modulesForRole((string) $user['role']);
$activeModule = 'desarrollo-usuarios';
$pageTitle = 'Usuarios';
?>
<!doctype html>
<html lang="es">
    ...
    <main class="workspace">
        ...
        <section class="workspace-content">
            ...
            <section class="development-placeholder">
                ...
                <p>Aquí se implementará el creador y administrador real de usuarios, roles y credenciales.</p>
            </section>
        </section>
    </main>
</div>
